...
const CategoryPage = () => {
    ...
    if (loading) {
        return (
            <>
                <Navbar />
                <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '50vh', color: 'white' }}>
        ...
        return (
            <>
                ...
                <div className="container text-center py-5 text-light">
                    <h2>{error}</h2>
                    <button className="btn btn-outline-light mt-3" onClick={() => navigate('/dashboard')}>
                        Back to Dashboard
                    </button>
                </div>
                <Footer />
